...
////// Emissive:
                ...
                float3 node_110 = lerp(tex2Dlod(_MainTex,float4(TRANSFORM_TEX(node_94, _MainTex),0.0,node_132)).rgb,tex2Dlod(_MainTex,float4(TRANSFORM_TEX(node_141, _MainTex),0.0,node_132)).rgb,saturate(node_219));
